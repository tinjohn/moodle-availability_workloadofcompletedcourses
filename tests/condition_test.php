...
use availability_workloadofcompletedcourses\condition;
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class availability_workloadofcompletedcourses_condition_testcase extends advanced_testcase {
    /**
    ...
    public function test_completion_value_used() {
        ...
        availability_workloadofcompletedcourses\condition::wipe_static_cache();
        ...
        $this->assertTrue(availability_workloadofcompletedcourses\condition::completion_value_used(
                $course, $page1->cmid));
        $this->assertTrue(availability_workloadofcompletedcourses\condition::completion_value_used(
                $course, $page2->cmid));
        $this->assertFalse(availability_workloadofcompletedcourses\condition::completion_value_used(
                $course, $page3->cmid));
    }
